...
ssh tunnel management.  Why consider such a project, when there are numerous ssh tunnel managers out there?  First and foremost, all aspects of the project run within a chroot envrionment with ease.  Secondly, a pure ruby client authenticates over http to receive a private key 
